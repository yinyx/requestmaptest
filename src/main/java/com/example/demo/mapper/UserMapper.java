...
public interface UserMapper {
    ...
    @Update("UPDATE sys_user SET user_name=#{userName},phone=#{phone},has_del=#{status},update_by=#{loginUser},update_time=NOW(),operate_authority=#{authority} WHERE id = #{userId}")
